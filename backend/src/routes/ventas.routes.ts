...
export default (app: Express): void => {
   ...
   */
  router.post('/', ...requireCliente, extractTenant, (req: Request, res: Response, next: NextFunction) => {
   ...
   */
  router.get('/:id', ...requireCliente, extractTenant, (req: Request, res: Response, next: NextFunction) => {
